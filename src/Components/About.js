...
function About(){
    return(
        <div className="about bg-dark text-white p-4" style={{textAlign:'center'}}>
            <h1 className="text-danger"><a class="link-offset-2 link-underline link-underline-opacity-100" href="#">About Our company</a></h1>
            <p>WRITE</p>
            <h2 className="text-danger"><a class="link-offset-2 link-underline link-underline-opacity-100" href="#">About Our CEO</a></h2>
            ...
            <p>Our Manager is Felix Okeyo. 
                ...
                <p className="fw-bold text-warning">***********@ourcompany.com </p>
                or call us at:
